...
public class P0ArrayListTest extends BaseTest {
    ...
    public class MyArrayList {
        ...
        public void resize(int indexFrom, int indexTo) {
            if ((indexFrom < 0) || (indexFrom > realSize) && (indexTo < 0) || (indexTo > myArray.length)) {
                throw new IndexOutOfBoundsException();
            } else {
                System.arraycopy(myArray, indexFrom, myArray, indexTo, myArray.length - indexTo);
            }
        }
    ...
    public void test() throws Throwable {
        ...
        removeMethod = ReflectionUtil.checkMethod(unitClass, REMOVE_METHOD_NAME, boolean.class,
                new MethodModifier[]{MethodModifier.PUBLIC}, int.class);
    }
