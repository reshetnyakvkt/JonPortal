            ...
            <div class="tab-content">
                <div class="row">
                    ...
                    <div class="span8">
                        ...
                        <div class="row">
                            <div class="span8">
                                <blockquote class="pull-right">
                                    <p>Начиная занятия с новой группой, некторое время</p>
                        ...
                        <p>Выполнить команду git update или svn update. Эта команда для системы контроля версий, синхронизирующая код в хранилище с локальной рабочей копией</p>
                        ...
                        <p>Код, не описывающий непосредственно логику работы программы, но который необходимо писать</p>
                        ...
                        <h4>Быдлокодер</h4>
                        <p>Человек, который не умеет программировать. Не хочет или не понимает зачем нужно знать алгоритмы, использовать шаблоны проектирования, поддерживать стиль кодирования и т.п. Чаще всего быдлокодер использует готовые решения и компоненты, не заботится о повторном использовании кода</p>
                        ...
                        <p>Разработчик. Часто на русский не переводятся и приставки, например "синиор девелопер" (старший разработчик)</p>
                        ...
                        <h4>Дыра</h4>
                        <p>Способ, не предусмотренный разработчиками ПО, и позволяющий получить к чему-либо несанкционированный доступ</p>
                        ...
                        <h4>Капча</h4>
                        <p>Система распознавания человека путём показа букв или цифр, которые нужно ввести для подтверждения</p>
                        ...
                        <h4>Класстрофобия</h4>
                        <p>Отказ от объектно-ориентированного подхода при очевидной необходимости и возможности его использования</p>

                        <h4>Код</h4>
                        <p>Исходный код программы</p>

                        <h4>Комьюнити — англ. community</h4>
                        <p>Сообщество, группа пользователей одного и того же сетевого ресурса; разработчиков и др. одного программного продукта</p>
                        ...
                        <h4>Компилить</h4>
                        <p>От компилировать, процесс преобразования текста программы написанного на языке высокого уровня в машинный язык</p>

                        <h4>Курить</h4>
                        <p>Изучать что-либо</p>

                        <h4>Костыль</h4>
                        <p>Уловка, обходной способ сделать что-либо в компьютерах и программировании. Как правило не понятный сходу и трудоёмкий. Но часто являющийся единственным способом решить проблему / использовать технологию.</p>

                        <h4>Комбинация из трёх пальцев</h4>
                        <p><ctrl>+<alt>+<delete></p>

                        <h4>Кривой</h4>
                        <p>Кривая программа – плохо структурированная и/или с большим количеством багов. Работающая, но в некоторых случаях вызывающая проблемы</p>

                        <h4>Китайский код</h4>
                        <p>Код, написанный методом копирования-вставки; решение задачи в лоб, без поиска подходящих алгоритмов, без оптимизации</p>
                        ...
                        <h4>Родить</h4>
                        <p>Выдать результат и вообще сделать что-нибудь осмысленное после долгой имитации глубоких раздумий</p>
                        ...
                        <p>Разработка, управляемая страхом — когда руководитель только подливает масла в огонь и оказывает излишнее давление на разработчиков</p>
                        ...
                        <h4>Хак</h4>
                        <p>модификация кода программы, позволяющая уменьшить размер программы, расширить функциональность или ускорить её работу, наконец просто красивое программистское решение</p>

                        <h4>Хип</h4>
                        <p>Структура данных (англ. heap – куча, также «пирамида»), двоичное дерево с выполнением правила кучи (каждая вершина больше (меньше) либо равна своему предку)</p>

                        <h4>Hope Driven Development</h4>
                        <p>Разработка, управляемая надеждой — разработка в длительном неспланированном цикле с надеждой, что все заработает в релизе</p>
                        ...
                        <h4>Чайник</h4>
                        <p>Малоопытный пользователь, человек, который не умеет целесообразно пользоваться персональным компьютером в нужном для него объёме</p>
