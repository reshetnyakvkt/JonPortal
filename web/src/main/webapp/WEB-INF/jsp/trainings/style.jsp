            ...
            <div class="tab-content">
                <div class="row">
                    ...
                    <div class="span8">
                        ...
                        <p>Имена классов начинаются с заглавной буквы, нзвание представляет собой существительные, записанные с использованием "верблюжей нотации" (camel case)</p>
                        <p>К интерфейсам применяются правила классов</p>
                        <p>Имена методов начинаются с маленькой буквы, и название начинается с глагола и записывается с использованием "верблюжей нотации"</p>
                        <p>Имена переменных начинаются с маленькой буквы и записывается с использованием "верблюжей нотации"</p>
